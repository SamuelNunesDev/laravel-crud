...
<div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="modal-deleteLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form id="form-delete-cargo" method="POST">
        @csrf
        @method('DELETE')
        <input type="hidden" id="delete-cargo">
        <div class="modal-header">
          <h5 class="modal-title" id="modal-deleteLabel">Deletar Cargo</h5>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-danger" id="btn-submit-delete">
            <i class="fa fa-times-circle mr-1"></i> Deletar Cargo
          </button>
        </div>
      </form>
    </div>
