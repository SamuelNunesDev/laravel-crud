...
<div class="modal fade" id="modal-editar" tabindex="-1" role="dialog" aria-labelledby="modal-editarLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form id="form-edit-cargo" method="POST">
        @csrf
        @method('PUT')
        <input type="hidden" id="edit-cargo">
        <div class="modal-header">
          <h5 class="modal-title" id="modal-editarLabel">Editar Cargo</h5>
        ...
        <div class="modal-body">
            <div class="form-group">
              <label for="edit-cargo-nome">Nome:</label>
              <input type="text" name="nome" id="edit-cargo-nome" class="form-control" required>
            </div>
        </div>
