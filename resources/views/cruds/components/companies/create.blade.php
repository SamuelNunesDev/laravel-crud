    ...
    <div class="modal-content">
      <form action="{!! route('companies.store') !!}" method="POST">
        ...
        <div class="modal-header">
          <h5 class="modal-title" id="modal-cadastroLabel">Cadastrar Empresa</h5>
        ...
        <div class="modal-body">
          ...
          <input type="text" id="input-nome-cadastro" class="form-control mb-3" name="nome" placeholder="Digite o nome da empresa" required>
        </div>
